...
export default function About(props) {
    ...
    <h1>About Us</h1>
      <div className="accordion" id="accordionExample">
        <div className="accordion-item">
          ...
          >
            ...
            TextUtils gives you a way to analyze youe text efficiently and quickly.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={props.myStyle}>
            TextUtils is a free character counter tool that provides instant character couter & word count statistics for a given text. TextUtils reports the number of words and characters. Thus it is suitable for writing text with word/ character limit.
            </div>
          </div>
        </div>
        <div className="accordion-item">
      ...
      <div className="container my-3" style={{padding:"10px"}}>
